...
interface Fase2BProps {
  setFase: (fase: number) => void;
  clientId: string;
}

const Fase2B: FC<Fase2BProps> = ({ setFase, clientId }) => {
  ...
  return (
    <div className='flex flex-col'>
      <p className='italic py-12 text-center'>Hemos encontrado al cliente Nº {clientId} en propuestas anteriores. Puedes modificar los datos ya introducidos, o continuar y preservarlos. </p>
      <p className="text-2xl pb-5">Datos del cliente </p>
